...
const AboutPage = () => {
  return (
    <div className="w-full flex flex-col justify-center items-center px-12 min-h-screen bg-gray-900 text-white">
      ...
      <p className="text-lg mt-4 text-center text-gray-300 max-w-4xl">
