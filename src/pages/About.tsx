...
const AboutPage = () => {
  return (
    ...
    <div className="w-full flex flex-col justify-center items-center px-12 min-h-screen bg-gray-900 text-black">
      <h1 className="text-3xl font-bold mt-12 text-center">About QSEC</h1>
      <p className="text-lg mt-6 text-center text-gray-300 max-w-4xl">
      ...
      <footer className="w-full py-6 bg-blue-800 text-white text-center mt-12">
        <p>&copy; 2024 QSEC</p>
      </footer>
    </div>
  );
